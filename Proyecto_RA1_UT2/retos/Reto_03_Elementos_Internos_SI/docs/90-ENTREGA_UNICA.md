...
**Notas/criterios de la tienda 3:** En LDLC encuentras variedad más allá que solo "gaming", por ejemplo, venden fuentes para workstations de 3000W, que es un producto para un entorno más profesional. Además, por esa razón, tambien tiene más opciones para SFX y TFX.
